...
def main():
    ...
    ap.add_argument("--tau", type=float, default=0.7, help="(Fallback) confidence threshold if --taus not provided")
    ...
    ap.add_argument(
        "--ckpt",
        type=str,
        default="checkpoints/best_resnet18_att_softcgt_cifar100_tau_0.9.pth",
